...
import { Stack, Container, Typography, Box, Button, Link } from "@mui/material";
    ...
    <Container maxWidth="lg" sx={sx.root}>
      <Stack sx={sx.header} spacing={2}>
        ...
        <Typography variant="body1" maxWidth={700} sx={sx.subtitle}>
          That's Why We Created Active Source Lab—The World’s First Truly
          Wholesale Creator for Your Branded Apparel.
        </Typography>
      </Stack>
      <Stack>
        {ITEMS.map((item, i) => {
