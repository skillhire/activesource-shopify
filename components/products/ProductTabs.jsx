  ...
  return (
    <Box sx={sx.root}>
      ...
      >
        ...
        {!disableShipping && <Tab value={1} label="Shipping" />}
        {!disableFileGuidelines && <Tab value={2} label="File Guidlines" />}
      </Tabs>
      <Stack sx={sx.content}>
        <Box sx={sx.tabContent}>
          ...
          {tab == 2 && (
            <Typography sx={sx.text} variant="body1">
              ...
              <br />
              • Resolution: at least 300 pixels per inch (PPI). For example,
              14”x4” center-front placement needs an image that is 4200px x
              1200px.
              <br />
              <br />
              For more details, see our{" "}
              <Link href="/docs/printing-guide">Printing Guide</Link>. Want a
              custom placement? See our{" "}
              <Link href="/docs/placement-guide">Custom Placement Guide</Link>.
              Still confused?{" "}
              <Link href="/contact-us">Contact Customer Service</Link> with
